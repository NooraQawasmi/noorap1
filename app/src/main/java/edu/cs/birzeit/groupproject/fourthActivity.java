...
public class fourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://10.0.2.2:80/rest/info.php?cat=programming";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i = 0; i<array.length(); i++){
                                ...
                                String CDDetails = "";
                                CDDetails = "id: " + obj.getInt("id") +
                                        "\n, tittle: " + obj.getString("tittle") +
                                        "\n, min: " + obj.getString("category") +
                                        ", max: " + obj.getInt("pages");
                                days[i] = CDDetails;
                            }
                            ArrayAdapter<String> itemsAdapter =
                                    new ArrayAdapter<String>(fourthActivity.this, android.R.layout.simple_list_item_1, days);
...
//                            }
//                            ArrayAdapter<String> itemsAdapter =
//                                    new ArrayAdapter<String>(fourthActivity.this, android.R.layout.simple_list_item_1,
//                                            days);
//                            lst.setAdapter(itemsAdapter);
//                        } catch (JSONException e) {
//                            e.printStackTrace();
